...
NodeDataType TextSourceDataModel::dataType(PortType portType, PortIndex portIndex) const
{
    return TextData().type();
}

std::shared_ptr<NodeData> TextSourceDataModel::outData(PortIndex port)
{
